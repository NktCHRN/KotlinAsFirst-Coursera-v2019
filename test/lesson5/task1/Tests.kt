...
class Tests {
    ...
    fun bagPacking() {
        ...
        assertEquals(
            setOf("Кубок", "Кости", "Череп"),
            bagPacking(
                mapOf(
                    "Кубок" to (500 to 2000),
                    "Слиток" to (1000 to 5000),
                    "Кости" to (150 to 1500),
                    "Череп" to (75 to 100),
                    "Корона" to (300 to 5)
                ),
                850
        ...
        assertEquals(
            ...
            bagPacking(
                mapOf(
                    ...
                    "Череп" to (75 to 100),
                    "Корона" to (300 to 5000)
                ),
                100
            )
        )
        assertEquals(
            setOf("Слиток", "Изумруд"),
            bagPacking(
                mapOf(
                    "Кубок" to (500 to 2000),
                    "Слиток" to (100 to 1000),
        ...
        assertEquals(
            setOf(
                "Корона", "Старинная монета 1 Пиастр", "Старинная монета 2 Пиастра", "Старинная монета 100 Пиастр",
                "Старинная монета 200 Пиастр", "Изумруд", "Бриллиант"
            ),
            bagPacking(
                mapOf(
                    "Кубок" to (8000 to 500000),
                    "Корона" to (7000 to 700000),
                    "Слиток золота" to (1000 to 15000),
                    "Слиток серебра" to (1000 to 9515),
                    "Старинная монета 1 Пиастр" to (5 to 20000),
                    "Старинная монета 2 Пиастра" to (6 to 25000),
                    "Старинная монета 100 Пиастр" to (10 to 50000),
                    "Старинная монета 200 Пиастр" to (12 to 70000),
                    "Изумруд" to (3 to 127500),
                    "Бриллиант" to (2 to 300000)
                ),
                8000
            )
        )
